start_server {tags {"keyspace"}} {
    ...
    foreach {type large} [array get largevalue] {
        ...
        test "COPY basic usage for list - $type" {
            ...
            catch {r lpush mylist{t} a b $large c d} err
            format $err
    ...
    # **************************************************************************
    # --------- TODO:::  TESTS below are waiting to be fixed ----------
    # **************************************************************************
    ...
    # --------- COPY WITH DB arg support COMMAND ----------
    ...
    # --------- COPY/XADD/XGROUP/XREADGROUP/XDEL COMMAND ----------
