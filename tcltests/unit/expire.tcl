start_server {tags {"expire"}} {
    ...
    test {EXPIRE - write on expire should work} {
        ...
        r expire x 1000
        r lpush x bar
        # TODO: this should be uncommented after support of lrange
        # [r lrange x 0 -1]
    } {OK}
    ...
    test {PERSIST can undo an EXPIRE} {
        ...
        ## Modifications
        set ttl [r ttl x]
        set ttl_ok [expr {($ttl >= 35) && ($ttl <= 50)}]
        list $ttl_ok [r persist x] [r ttl x] [r get x]
    } {1 1 -1 foo}
    ...
    test {TTL / PTTL / EXPIRETIME / PEXPIRETIME return -1 if key has no expire} {
        r del x
        r set x hello
        # TODO: [r expiretime x] [r pexpiretime x] to be added later 
    ...
    # start_server {overrides {appendonly {yes} appendfsync always} tags {}} {
